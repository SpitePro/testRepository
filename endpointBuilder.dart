class Builder {
  ...
  /// Про indexOf и то, что можно было просто разделять через split по "/" и
  /// найти слово знаю, но просто чтобы освоиться в языке, решил вручную сам
  /// реализовать (упрощенный алгоритм Бойера-Мура)
